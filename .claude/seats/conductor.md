...
Read the INTENT, the LADDER of what this plan owes before its seal (set by its rigor and by whether the app is new), the CATALOGUE of what can be produced, and SO FAR: what earlier waves of this plan produced and decided, with each document's commit, each gap they closed, and how each question was answered. You are called again after every wave, with SO FAR updated, until you decide no-move. Choose one outcome:
